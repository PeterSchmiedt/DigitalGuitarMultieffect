...
void InitializeHardware(void) {
    ...
    fxDataStruct[0].FUZZ.isOn = TRUE;
    fxDataStruct[0].FUZZ.gain = 100;
    fxDataStruct[0].FUZZ.mix = 20;
    fxDataStruct[0].OVERDRIVE.isOn = FALSE;
    fxDataStruct[0].OVERDRIVE.treshold = 2000;

    fxDataStruct[1].FUZZ.isOn = TRUE;
    fxDataStruct[1].FUZZ.gain = 50;
    fxDataStruct[1].FUZZ.mix = 1;
    fxDataStruct[1].OVERDRIVE.isOn = FALSE;
    fxDataStruct[1].OVERDRIVE.treshold = 2000;

    fxDataStruct[2].FUZZ.isOn = FALSE;
    fxDataStruct[2].FUZZ.gain = 100;
    fxDataStruct[2].FUZZ.mix = 20;
    fxDataStruct[2].OVERDRIVE.isOn = TRUE;
    fxDataStruct[2].OVERDRIVE.treshold = 2000;

    fxDataStruct[3].FUZZ.isOn = FALSE;
    fxDataStruct[3].FUZZ.gain = 100;
    fxDataStruct[3].FUZZ.mix = 20;
    fxDataStruct[3].OVERDRIVE.isOn = TRUE;
    fxDataStruct[3].OVERDRIVE.treshold = 1000;

    fxDataStruct[4].FUZZ.isOn = TRUE;
    fxDataStruct[4].FUZZ.gain = 100;
    fxDataStruct[4].FUZZ.mix = 20;
    fxDataStruct[4].OVERDRIVE.isOn = TRUE;
    fxDataStruct[4].OVERDRIVE.treshold = 2000;
...
inline void ReadUSBData(void) {
    ...
    //if (!FSfeof(fxFile)) {
    //  fxDataCount = FSfread(Sin, sizeof (STEREO_AUDIO_DATA), FRAME_SIZE, fxFile);

    //}


    /*
        if (fxDataCount != FRAME_SIZE) {
            //SetFont((void *) &Font25);
            //SetColor(BLACK);
