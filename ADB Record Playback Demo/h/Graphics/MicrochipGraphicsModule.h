 ...
 * PAT								04 Apr 2010                 Added block scrolling 
 *****************************************************************************/
...
#define GFX_SetDisplayArea(a)               { DWORD address = (DWORD)a; G1DPADRL = ((DWORD_VAL)(address)).word.LW; G1DPADRH = ((DWORD_VAL)(address)).word.HW; }
#define GFX_SetWorkArea1(a)                 { DWORD address = (DWORD)a; G1W1ADRL = ((DWORD_VAL)(address)).word.LW; G1W1ADRH = ((DWORD_VAL)(address)).word.HW; }
#define GFX_SetWorkArea2(a)                 { DWORD address = (DWORD)a; G1W2ADRL = ((DWORD_VAL)(address)).word.LW; G1W2ADRH = ((DWORD_VAL)(address)).word.HW; }
...
///*********************************************************************
//* Function:  SHORT DrvGetImageHeight(BITMAP_EDS *pBitmap)
//*
...
//*               by the pointer pBitmap.
//*
//* Input: pBitmap - Pointer to the bitmap.
//*
...
//*
//********************************************************************/
//SHORT   DrvGetImageHeight(BITMAP_EDS *pBitmap);
//
///*********************************************************************
//* Function:  SHORT DrvGetImageWidth(BITMAP_EDS *pBitmap)
//*
...
//*
//********************************************************************/
//SHORT   DrvGetImageWidth(BITMAP_EDS *pBitmap);
